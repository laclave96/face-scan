...
class FacesDialog(context: Context, faces: List<DetectedFaceItem>) : BottomSheetDialog(context),
    ...
    init {
        ...
        title?.text = context.getString(R.string.faces_detected)
